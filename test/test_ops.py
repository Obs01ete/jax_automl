...
from gradient_automl_linear import (predict_latencies, rem_loss_fn,
    total_latency_fn, latency_loss_fn, create_constraints,
...
class TestOps(unittest.TestCase):
    ...
    def test_ops(self):
        op_type = 'linear'
        dataset = load_or_create_dataset(op_type, None)
        ...
        lat_args = (predict_flax, params,
            input_features_size, test_features_array, constraints)
        ...
        raw_latencies = predict_latencies(predict_flax, params,
            input_features_size, test_features_array)
        ...
        vnj = cp_value_and_jacobian(test_features_array, predict_flax,
            params, input_features_size, constraints)
